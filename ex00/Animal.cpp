...
/*   Updated: 2025/08/16 16:08:28 by aokhapki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "\033[32mAnimal default constructor created\033[0m" << std::endl;
}

Animal::Animal(const std::string& type) : m_type(type)
{
    std::cout << "\033[32mAnimal parameterized constructor created for type: " << m_type << "\033[0m" << std::endl;
}

Animal::Animal(const Animal& src) : m_type(src.m_type)
{
    std::cout << "\033[32mAnimal copy constructor created for type: " << m_type << "\033[0m" << std::endl;
}
...
{
    std::cout << "Animal sound: " << m_type << " makes some animal's sound!" << std::endl;
}
