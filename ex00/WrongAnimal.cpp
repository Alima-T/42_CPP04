...
/*   Updated: 2025/08/16 16:12:24 by aokhapki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "\033[31mWrongAnimal default constructor\033[0m" << std::endl;
}

WrongAnimal::WrongAnimal(const std::string& type) : m_type(type)
{
    std::cout << "\033[31mWrongAnimal parameterized constructor\033[0m" << std::endl;
}
...
{
    std::cout << "\033[31mWrongAnimal destructor\033[0m" << std::endl;
}

void WrongAnimal::makeSound() const
{
    std::cout << "WrongAnimal makes a standard wrong sound!" << std::endl;
}
