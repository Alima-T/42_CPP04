...
/*   Updated: 2025/08/20 18:18:14 by aokhapki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#include <string>
/*
*Pure virtual functionЧисто виртуальная функция 
*keyword virtual
*override
...
public:
	...
	virtual ~AAnimal(); //very important to make destractor virtual to avoid memleaks
